      ...
      content: (
        <div>
          ...
          <Row justify="end" gutter={[16, 16]}>
            <Col>
              <Button.Outline danger onClick={generateMnemonic}>
            ...
            <Col>
              <CopyToClipboard text={mnemonic.string}>
                <Button.Outline primary onClick={() => toast.success('Copied')}>
  ...
  return (
    <div>
      ...
      <center>
        ...
        {current === steps.length - 1 && (
          <Button.Primary block medium onClick={handleComplete}>
            Complete
          </Button.Primary>
        )}
      </center>
