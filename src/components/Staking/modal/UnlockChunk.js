...
export default function UnlockChunk({ visible, setVisible }) {
      ...
      >
        ...
        {withdrawAvailable.toNumber() > 0 && (
          <div>
            ...
            <p>{withdrawAvailable.toNumber()} CDM</p>
            <br />
          ...
          unlocking.map((chunk) => {
            ...
            return (
              <div>
                ...
                <br />
                <p>
                  Unlocks take {left} eras before they can be withdrawn. You can
                  rebond unlocks at any time in this period, or withdraw them to
