          ...
          <Link to="/earn/staking">
            <div className="earn-menu-item">
              <Card style={{ height: '100%' }}>
                ...
                <p>
                  Staking your Selendra (SEL) allows you to passively earn
                  rewards for your help to secure the network.
                </p>
              </Card>
            </div>
          </Link>
          ...
          <Link to="/staking/payout">
            <div className="earn-menu-item">
              <Card style={{ height: '100%' }}>
                ...
                <hr style={{ marginBottom: '8px' }} />
                <p>
                  Selendra make stakers claim their rewards for past eras by
